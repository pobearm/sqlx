...
func (db *DB) NamedGetContext(ctx context.Context, dest any, query string, arg interface{}) error {
...
func (tx *Tx) NamedGetContext(ctx context.Context, dest any, query string, arg interface{}) error {
